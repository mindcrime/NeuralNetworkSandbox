...
public class ExpMain4 
{
	public static void main(String[] args) throws Exception
	{
		
		
		File temp = new File( "/home/centos/foo.log" );
		BufferedWriter tempOut = null;
		try 
		{
			tempOut = new BufferedWriter(new FileWriter(temp));
			tempOut.write( "Starting ExpMain4 job!" + "\n");
			// tempOut.write( "appId: " + appId + "\n");
			InetAddress addr = InetAddress.getLocalHost();
			tempOut.write( "host: " + addr.getHostName() + " - " + addr.getHostAddress() + "\n" );
			tempOut.flush();
		}
		finally
		{
		...
		sparkConf.setAppName("SparkNeuralNetwork4");
